...
<html lang="en">
  <head>
    ...
    <title>Welcome to Hostel Searching</title>
...
<!-- End WOWSlider.com HEAD section -->
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Hostel Searching</a>
...
<!-- End WOWSlider.com BODY section -->
    ...
    <footer style="background-color: #ccc;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">Desing by NIRAJ | AKASH | AJAY</span>
          </div>
          <div class="col-md-4">
